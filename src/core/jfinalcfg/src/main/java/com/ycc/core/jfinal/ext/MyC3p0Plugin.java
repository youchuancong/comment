...
public class MyC3p0Plugin implements IPlugin, IDataSourceProvider {
	...
	public MyC3p0Plugin setDriverClass(String driverClass) {
	...
	public MyC3p0Plugin setMaxPoolSize(int maxPoolSize) {
		if (maxPoolSize < 1)
	...
	public MyC3p0Plugin setMinPoolSize(int minPoolSize) {
		if (minPoolSize < 1)
	...
	public MyC3p0Plugin setInitialPoolSize(int initialPoolSize) {
	...
	public MyC3p0Plugin setMaxIdleTime(int maxIdleTime) {
		if (maxIdleTime < 1)
	...
	public MyC3p0Plugin setAcquireIncrement(int acquireIncrement) {
	...
	public MyC3p0Plugin(String jdbcUrl, String user, String password, String driverClass) {
		this.jdbcUrl = jdbcUrl;
		this.user = user;
		this.password = password;
	...
	public MyC3p0Plugin(String jdbcUrl, String user, String password, String driverClass, Integer maxPoolSize, Integer minPoolSize, Integer initialPoolSize, Integer maxIdleTime, Integer acquireIncrement) {
